...
require ('./tags/slide-tray.tag');

require ('./tags/slideshow-viewer.tag');
require ('./tags/asset-listing.tag');
require('./tags/family-section.tag');
require('./tags/family-name.tag');
require('./tags/asset-container.tag');
require('./tags/asset.tag');

require('./tags/gallery.tag')

riot.mount('*');
},{"./tags/asset-container.tag":5,"./tags/asset-listing.tag":6,"./tags/asset.tag":7,"./tags/family-name.tag":8,"./tags/family-section.tag":9,"./tags/gallery.tag":10,"./tags/slide-tray.tag":11,"./tags/slideshow-viewer.tag":12,"riot":3}],2:[function(require,module,exports){
...
var riot = require('riot');
module.exports = riot.tag2('asset-container', '<div> <asset each="{asset, index in assets}"></asset> </div>', 'asset-container div,[riot-tag="asset-container"] div,[data-is="asset-container"] div{ display: flex; justify-content: flex-start; -webkit-justify-content: flex-start; flex-flow: row wrap; text-align:left; background-color: #000; border: 1px solid #111; color:#a00; }', '', function(opts) {
		var thisTag = this;
		thisTag.assets = [];
...
var riot = require('riot');
module.exports = riot.tag2('asset-listing', '<div class="container"> <asset each="{data in assets}"></asset> </div>', 'asset-listing .container,[riot-tag="asset-listing"] .container,[data-is="asset-listing"] .container{ display: flex; flex-direction: row; justify-content: flex-center; align-items: flex-center; flex-wrap: wrap; }', '', function(opts) {
		var thisTag = this;
...
var riot = require('riot');
module.exports = riot.tag2('asset', '<div class="thumb" id="{asset_id}"> <img id="thumbimg" src="" onclick="{tapThumb}"> </div>', 'asset .thumb,[riot-tag="asset"] .thumb,[data-is="asset"] .thumb{ display: flex; justify-content: center; align-items: center; flex-direction: column; cursor: pointer; }', '', function(opts) {
		var thisTag = this;
		...
		var orientation = meta['size1']['orientation'];
...
var riot = require('riot');
module.exports = riot.tag2('family-name', '<div class="family_name">{display_name}</div>', '.family_name { color:#eee; font-family: Helvetica; font-size:1em; border-bottom: 1px solid #222; padding:.4em; padding-left: 0; margin-left:0; margin-top:10px; }', '', function(opts) {
	var thisTag = this;
...
var riot = require('riot');
module.exports = riot.tag2('family-section', '<div class="family_name">{display_name}</div>', '.family_name { color:#eee; font-family: Helvetica; font-size:1em; border-bottom: 1px solid #eee; padding:.4em; }', '', function(opts) {
		var thisTag = this;
		thisTag.on('mount', function() {
			thisTag.assets = thisTag.opts.assets;
...
var riot = require('riot');
module.exports = riot.tag2('gallery', 'asdfalsdfkklj <div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"> <div class="pswp__bg"></div> <div class="pswp__scroll-wrap"> <div class="pswp__container"> <div class="pswp__item"></div> <div class="pswp__item"></div> <div class="pswp__item"></div> </div> <div class="pswp__ui pswp__ui--hidden"> <div class="pswp__top-bar"> <div class="pswp__counter"></div> <button class="pswp__button pswp__button--close" title="Close (Esc)"></button> <button class="pswp__button pswp__button--share" title="Share"></button> <button class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button> <button class="pswp__button pswp__button--zoom" title="Zoom in/out"></button> <div class="pswp__preloader"> <div class="pswp__preloader__icn"> <div class="pswp__preloader__cut"> <div class="pswp__preloader__donut"></div> </div> </div> </div> </div> <div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap"> <div class="pswp__share-tooltip"></div> </div> <button class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)"> </button> <button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)"> </button> <div class="pswp__caption"> <div class="pswp__caption__center"></div> </div> </div> </div> </div>', '.pswp { display: none; position: absolute; width: 100%; height: 100%; left: 0; top: 0; overflow: hidden; -ms-touch-action: none; touch-action: none; z-index: 1500; -webkit-text-size-adjust: 100%; -webkit-backface-visibility: hidden; outline: none; } .pswp * { -webkit-box-sizing: border-box; box-sizing: border-box; } .pswp img { max-width: none; } .pswp--animate_opacity { opacity: 0.001; will-change: opacity; -webkit-transition: opacity 333ms cubic-bezier(0.4, 0, 0.22, 1); transition: opacity 333ms cubic-bezier(0.4, 0, 0.22, 1); } .pswp--open { display: block; } .pswp--zoom-allowed .pswp__img { cursor: -webkit-zoom-in; cursor: -moz-zoom-in; cursor: zoom-in; } .pswp--zoomed-in .pswp__img { cursor: -webkit-grab; cursor: -moz-grab; cursor: grab; } .pswp--dragging .pswp__img { cursor: -webkit-grabbing; cursor: -moz-grabbing; cursor: grabbing; } .pswp__bg { position: absolute; left: 0; top: 0; width: 100%; height: 100%; background: #000; opacity: 0; transform: translateZ(0); -webkit-backface-visibility: hidden; will-change: opacity; } .pswp__scroll-wrap { position: absolute; left: 0; top: 0; width: 100%; height: 100%; overflow: hidden; } .pswp__container, .pswp__zoom-wrap { -ms-touch-action: none; touch-action: none; position: absolute; left: 0; right: 0; top: 0; bottom: 0; } .pswp__container, .pswp__img { -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; -webkit-tap-highlight-color: transparent; -webkit-touch-callout: none; } .pswp__zoom-wrap { position: absolute; width: 100%; -webkit-transform-origin: left top; -ms-transform-origin: left top; transform-origin: left top; -webkit-transition: -webkit-transform 333ms cubic-bezier(0.4, 0, 0.22, 1); transition: transform 333ms cubic-bezier(0.4, 0, 0.22, 1); } .pswp__bg { will-change: opacity; -webkit-transition: opacity 333ms cubic-bezier(0.4, 0, 0.22, 1); transition: opacity 333ms cubic-bezier(0.4, 0, 0.22, 1); } .pswp--animated-in .pswp__bg, .pswp--animated-in .pswp__zoom-wrap { -webkit-transition: none; transition: none; } .pswp__container, .pswp__zoom-wrap { -webkit-backface-visibility: hidden; } .pswp__item { position: absolute; left: 0; right: 0; top: 0; bottom: 0; overflow: hidden; } .pswp__img { position: absolute; width: auto; height: auto; top: 0; left: 0; } .pswp__img--placeholder { -webkit-backface-visibility: hidden; } .pswp__img--placeholder--blank { background: #222; } .pswp--ie .pswp__img { width: 100% !important; height: auto !important; left: 0; top: 0; } .pswp__error-msg { position: absolute; left: 0; top: 50%; width: 100%; text-align: center; font-size: 14px; line-height: 16px; margin-top: -8px; color: #CCC; } .pswp__error-msg a { color: #CCC; text-decoration: underline; } .pswp__button { width: 44px; height: 44px; position: relative; background: none; cursor: pointer; overflow: visible; -webkit-appearance: none; display: block; border: 0; padding: 0; margin: 0; float: right; opacity: 0.75; -webkit-transition: opacity 0.2s; transition: opacity 0.2s; -webkit-box-shadow: none; box-shadow: none; } .pswp__button:focus, .pswp__button:hover { opacity: 1; } .pswp__button:active { outline: none; opacity: 0.9; } .pswp__button::-moz-focus-inner { padding: 0; border: 0; } .pswp__ui--over-close .pswp__button--close { opacity: 1; } .pswp__button, .pswp__button--arrow--left:before, .pswp__button--arrow--right:before { background: url("css/default-skin/default-skin.png") 0 0 no-repeat; background-size: 264px 88px; width: 44px; height: 44px; } @media (-webkit-min-device-pixel-ratio: 1.1), (-webkit-min-device-pixel-ratio: 1.09375), (min-resolution: 105dpi), (min-resolution: 1.1dppx) { .pswp--svg .pswp__button, .pswp--svg .pswp__button--arrow--left:before, .pswp--svg .pswp__button--arrow--right:before { background-image: url("css/default-skin/default-skin.svg"); } .pswp--svg .pswp__button--arrow--left, .pswp--svg .pswp__button--arrow--right { background: none; } } .pswp__button--close { background-position: 0 -44px; } .pswp__button--share { background-position: -44px -44px; } .pswp__button--fs { display: none; } .pswp--supports-fs .pswp__button--fs { display: block; } .pswp--fs .pswp__button--fs { background-position: -44px 0; } .pswp__button--zoom { display: none; background-position: -88px 0; } .pswp--zoom-allowed .pswp__button--zoom { display: block; } .pswp--zoomed-in .pswp__button--zoom { background-position: -132px 0; } .pswp--touch .pswp__button--arrow--left, .pswp--touch .pswp__button--arrow--right { visibility: hidden; } .pswp__button--arrow--left, .pswp__button--arrow--right { background: none; top: 50%; margin-top: -50px; width: 70px; height: 100px; position: absolute; } .pswp__button--arrow--left { left: 0; } .pswp__button--arrow--right { right: 0; } .pswp__button--arrow--left:before, .pswp__button--arrow--right:before { content: \'\'; top: 35px; background-color: rgba(0, 0, 0, 0.3); height: 30px; width: 32px; position: absolute; } .pswp__button--arrow--left:before { left: 6px; background-position: -138px -44px; } .pswp__button--arrow--right:before { right: 6px; background-position: -94px -44px; } .pswp__counter, .pswp__share-modal { -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; } .pswp__share-modal { display: block; background: rgba(0, 0, 0, 0.5); width: 100%; height: 100%; top: 0; left: 0; padding: 10px; position: absolute; z-index: 1600; opacity: 0; -webkit-transition: opacity 0.25s ease-out; transition: opacity 0.25s ease-out; -webkit-backface-visibility: hidden; will-change: opacity; } .pswp__share-modal--hidden { display: none; } .pswp__share-tooltip { z-index: 1620; position: absolute; background: #FFF; top: 56px; border-radius: 2px; display: block; width: auto; right: 44px; -webkit-box-shadow: 0 2px 5px rgba(0, 0, 0, 0.25); box-shadow: 0 2px 5px rgba(0, 0, 0, 0.25); -webkit-transform: translateY(6px); -ms-transform: translateY(6px); transform: translateY(6px); -webkit-transition: -webkit-transform 0.25s; transition: transform 0.25s; -webkit-backface-visibility: hidden; will-change: transform; } .pswp__share-tooltip a { display: block; padding: 8px 12px; color: #000; text-decoration: none; font-size: 14px; line-height: 18px; } .pswp__share-tooltip a:hover { text-decoration: none; color: #000; } .pswp__share-tooltip a:first-child { border-radius: 2px 2px 0 0; } .pswp__share-tooltip a:last-child { border-radius: 0 0 2px 2px; } .pswp__share-modal--fade-in { opacity: 1; } .pswp__share-modal--fade-in .pswp__share-tooltip { -webkit-transform: translateY(0); -ms-transform: translateY(0); transform: translateY(0); } .pswp--touch .pswp__share-tooltip a { padding: 16px 12px; } a.pswp__share--facebook:before { content: \'\'; display: block; width: 0; height: 0; position: absolute; top: -12px; right: 15px; border: 6px solid transparent; border-bottom-color: #FFF; -webkit-pointer-events: none; -moz-pointer-events: none; pointer-events: none; } a.pswp__share--facebook:hover { background: #3E5C9A; color: #FFF; } a.pswp__share--facebook:hover:before { border-bottom-color: #3E5C9A; } a.pswp__share--twitter:hover { background: #55ACEE; color: #FFF; } a.pswp__share--pinterest:hover { background: #CCC; color: #CE272D; } a.pswp__share--download:hover { background: #DDD; } .pswp__counter { position: absolute; left: 0; top: 0; height: 44px; font-size: 13px; line-height: 44px; color: #FFF; opacity: 0.75; padding: 0 10px; } .pswp__caption { position: absolute; left: 0; bottom: 0; width: 100%; min-height: 44px; } .pswp__caption small { font-size: 11px; color: #BBB; } .pswp__caption__center { text-align: left; max-width: 420px; margin: 0 auto; font-size: 13px; padding: 10px; line-height: 20px; color: #CCC; } .pswp__caption--empty { display: none; } .pswp__caption--fake { visibility: hidden; } .pswp__preloader { width: 44px; height: 44px; position: absolute; top: 0; left: 50%; margin-left: -22px; opacity: 0; -webkit-transition: opacity 0.25s ease-out; transition: opacity 0.25s ease-out; will-change: opacity; direction: ltr; } .pswp__preloader__icn { width: 20px; height: 20px; margin: 12px; } .pswp__preloader--active { opacity: 1; } .pswp__preloader--active .pswp__preloader__icn { background: url("css/default-skin/preloader.gif") 0 0 no-repeat; } .pswp--css_animation .pswp__preloader--active { opacity: 1; } .pswp--css_animation .pswp__preloader--active .pswp__preloader__icn { -webkit-animation: clockwise 500ms linear infinite; animation: clockwise 500ms linear infinite; } .pswp--css_animation .pswp__preloader--active .pswp__preloader__donut { -webkit-animation: donut-rotate 1000ms cubic-bezier(0.4, 0, 0.22, 1) infinite; animation: donut-rotate 1000ms cubic-bezier(0.4, 0, 0.22, 1) infinite; } .pswp--css_animation .pswp__preloader__icn { background: none; opacity: 0.75; width: 14px; height: 14px; position: absolute; left: 15px; top: 15px; margin: 0; } .pswp--css_animation .pswp__preloader__cut { position: relative; width: 7px; height: 14px; overflow: hidden; } .pswp--css_animation .pswp__preloader__donut { -webkit-box-sizing: border-box; box-sizing: border-box; width: 14px; height: 14px; border: 2px solid #FFF; border-radius: 50%; border-left-color: transparent; border-bottom-color: transparent; position: absolute; top: 0; left: 0; background: none; margin: 0; } @media screen and (max-width: 1024px) { .pswp__preloader { position: relative; left: auto; top: auto; margin: 0; float: right; } } @-webkit-keyframes clockwise { 0% { -webkit-transform: rotate(0deg); transform: rotate(0deg); } 100% { -webkit-transform: rotate(360deg); transform: rotate(360deg); } } @keyframes clockwise { 0% { -webkit-transform: rotate(0deg); transform: rotate(0deg); } 100% { -webkit-transform: rotate(360deg); transform: rotate(360deg); } } @-webkit-keyframes donut-rotate { 0% { -webkit-transform: rotate(0); transform: rotate(0); } 50% { -webkit-transform: rotate(-140deg); transform: rotate(-140deg); } 100% { -webkit-transform: rotate(0); transform: rotate(0); } } @keyframes donut-rotate { 0% { -webkit-transform: rotate(0); transform: rotate(0); } 50% { -webkit-transform: rotate(-140deg); transform: rotate(-140deg); } 100% { -webkit-transform: rotate(0); transform: rotate(0); } } .pswp__ui { -webkit-font-smoothing: auto; visibility: visible; opacity: 1; z-index: 1550; } .pswp__top-bar { position: absolute; left: 0; top: 0; height: 44px; width: 100%; } .pswp__caption, .pswp__top-bar, .pswp--has_mouse .pswp__button--arrow--left, .pswp--has_mouse .pswp__button--arrow--right { -webkit-backface-visibility: hidden; will-change: opacity; -webkit-transition: opacity 333ms cubic-bezier(0.4, 0, 0.22, 1); transition: opacity 333ms cubic-bezier(0.4, 0, 0.22, 1); } .pswp--has_mouse .pswp__button--arrow--left, .pswp--has_mouse .pswp__button--arrow--right { visibility: visible; } .pswp__top-bar, .pswp__caption { background-color: rgba(0, 0, 0, 0.5); } .pswp__ui--fit .pswp__top-bar, .pswp__ui--fit .pswp__caption { background-color: rgba(0, 0, 0, 0.3); } .pswp__ui--idle .pswp__top-bar { opacity: 0; } .pswp__ui--idle .pswp__button--arrow--left, .pswp__ui--idle .pswp__button--arrow--right { opacity: 0; } .pswp__ui--hidden .pswp__top-bar, .pswp__ui--hidden .pswp__caption, .pswp__ui--hidden .pswp__button--arrow--left, .pswp__ui--hidden .pswp__button--arrow--right { opacity: 0.001; } .pswp__ui--one-slide .pswp__button--arrow--left, .pswp__ui--one-slide .pswp__button--arrow--right, .pswp__ui--one-slide .pswp__counter { display: none; } .pswp__element--disabled { display: none !important; } .pswp--minimal--dark .pswp__top-bar { background: none; }', '', function(opts) {
		var rowjam = require('rowjam')

});
},{"riot":3,"rowjam":4}],11:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('slide-tray', '<div id="box"> <div each="{family, index in families}"> <div class="family_name">{family.display_name}</div> <div class="family_thumbs"> <div each="{asset in parent.assetsByFamily[family.family_extid]}" class="placeholder" id="{asset.id}" onclick="{tapThumb}"> <img riot-src="../thumbs/{asset.size1_url}"> </div> </div> </div> </div> <div id="overlay" onclick="{tapOverlay}"> <img id="big_img" src="../photos/user_photo-1463021663937.jpg" onclick="{tapZoom}"> </div>', 'body { background-color: #000; } slide-tray #overlay,[riot-tag="slide-tray"] #overlay,[data-is="slide-tray"] #overlay{ background-color: rgba(0, 0, 0, 0.7); width:200px; height:200px; position: absolute; left:0; top:0; display: flex; justify-content: center; align-items: center; flex-direction: column; visibility: hidden; } slide-tray #box,[riot-tag="slide-tray"] #box,[data-is="slide-tray"] #box{ border: 2px solid #aa0; background-color:red; } slide-tray .family_name,[riot-tag="slide-tray"] .family_name,[data-is="slide-tray"] .family_name{ margin-top:20px; } slide-tray .family_thumbs,[riot-tag="slide-tray"] .family_thumbs,[data-is="slide-tray"] .family_thumbs{ display: flex; justify-content: left; flex-direction: row; flex-wrap: wrap; } slide-tray .placeholder,[riot-tag="slide-tray"] .placeholder,[data-is="slide-tray"] .placeholder{ width: 200px; height: 200px; background-color: #aaa; margin-right: 2px; margin-bottom: 2px; } slide-tray .placeholder img,[riot-tag="slide-tray"] .placeholder img,[data-is="slide-tray"] .placeholder img{ width: 200px; height: 200px; } slide-tray #container,[riot-tag="slide-tray"] #container,[data-is="slide-tray"] #container{ display: flex; justify-content: left; align-content: left; } slide-tray #big_img_div,[riot-tag="slide-tray"] #big_img_div,[data-is="slide-tray"] #big_img_div{ width: 500px; height:300px; overflow:visible; display: flex; justify-content: center; align-content: center; } slide-tray .thumb_wrapper,[riot-tag="slide-tray"] .thumb_wrapper,[data-is="slide-tray"] .thumb_wrapper{ width: 150px; height: 150px; } slide-tray .thumb_img,[riot-tag="slide-tray"] .thumb_img,[data-is="slide-tray"] .thumb_img{ width: 150px; height: 150px; } slide-tray .one_family,[riot-tag="slide-tray"] .one_family,[data-is="slide-tray"] .one_family{ display: flex; flex-direction: column; justify-content: left; align-content: left; } slide-tray #pan_cover,[riot-tag="slide-tray"] #pan_cover,[data-is="slide-tray"] #pan_cover{ border: 1px solid #fff; width: 500px; height:144px; position:absolute; left:0px; top:304px; cursor:pointer; }', '', function(opts) {
		var thisTag = this
...
},{"hammerjs":2,"riot":3,"rowjam":4}],12:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('slideshow-viewer', '<div id="box"> <div id="big_img_div"> <img id="big_img" src=""> </div> <div id="container"> <div class="one_family" each="{family, index in families}"> <asset-listing assets="{parent.assetsByFamily[family.family_extid]}"></asset-listing> <family-name family="{family}"></family-name> </div> </div> <div id="pan_cover"> </div> </div>', 'slideshow-viewer #box,[riot-tag="slideshow-viewer"] #box,[data-is="slideshow-viewer"] #box{ background-color: green; border: 2px solid #aa0; } slideshow-viewer #container,[riot-tag="slideshow-viewer"] #container,[data-is="slideshow-viewer"] #container{ display: flex; justify-content: left; align-content: left; position:absolute; } slideshow-viewer #big_img_div,[riot-tag="slideshow-viewer"] #big_img_div,[data-is="slideshow-viewer"] #big_img_div{ width: 500px; height:300px; overflow:visible; display: flex; justify-content: center; align-content: center; } slideshow-viewer .one_family,[riot-tag="slideshow-viewer"] .one_family,[data-is="slideshow-viewer"] .one_family{ } slideshow-viewer #pan_cover,[riot-tag="slideshow-viewer"] #pan_cover,[data-is="slideshow-viewer"] #pan_cover{ border: 1px solid #fff; width: 500px; height:144px; position:absolute; left:0px; top:304px; cursor:pointer; }', '', function(opts) {
		var thisTag = this;
		var Hammer = require('hammerjs');
