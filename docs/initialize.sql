...
insert into account (account_id, email, first_name, last_name, nickname, family_id, created_at, updated_at) values (2,'lee@leeseidenberg.com','Lee','Sidenberg','Lee', null, NOW(), NOW());
